...
async function main() {
  ...
  console.log('Insertando 22 Evaluaciones de Desempeño distribuidas...');
  ...
  // Distribución deseada para llegar a 22 en total:
  // - Pendiente: 11
  // - Emitido: 6
  // - Firmado: 2
  // - En Revisión: 1
  ...
  // Sincronizar contratos para empleados archivados
  ...
  console.log('¡22 Evaluaciones de prueba sembradas con éxito!');
